// Copied from <https://github.com/raywenderlich/swift-algorithm-club/tree/master/GCD>.
//
// See my correction to the `lcm()` function at bottom.
...
public func lcm(_ m: Int, _ n: Int, using gcdAlgorithm: (Int, Int) -> (Int) = gcdIterativeEuklid) throws -> Int {
	// TODO: This used to say `guard m & n ...`, which is wrong for pairs of numbers that
	// don't have any bits in common, like 132 (0b10000100) and 18 (0b00010010).  I should
	// submit a pull request.
    guard m != 0 && n != 0 else { throw LCMError.divisionByZero }
